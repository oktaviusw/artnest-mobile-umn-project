...
public class FragmentRequestList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        adapterCommissionList = new RVAListCommission(myView.getContext(),commissionData,"CommissionCustomer");
    ...
    private void seedData(){
        ...
        Call<JsonElement> callData = webServiceAPI.getAllCommissionData(idCustomer,"CUSTOMER");

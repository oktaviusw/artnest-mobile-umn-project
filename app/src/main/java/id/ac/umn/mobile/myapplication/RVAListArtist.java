...
public class RVAListArtist extends RecyclerView.Adapter<RVAListArtist.ViewHolder>{
    private Context context;
    private List<ModelArtistInformation> dataArtists;

    public RVAListArtist(Context context, List<ModelArtistInformation> data){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_template_artist, parent,false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        Picasso.get().load("https://artnest-umn.000webhostapp.com/assets/userdata/"+singleData.getEmail()+"/BackgroundProfile.jpg").fit().centerCrop()
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView){
            ...
            profileBackground = (ImageView) parentLayout.findViewById(R.id.profile_display_background);

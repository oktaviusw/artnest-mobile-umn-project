...
public class RVAListArtwork extends RecyclerView.Adapter<RVAListArtwork.ViewHolder>{

    private Context context;
    private List<ModelArtworkInformation> dataArtworks;

    public RVAListArtwork(Context context, List<ModelArtworkInformation> data){
        this.context = context;
        this.dataArtworks = data;
    }

    @Override
    public RVAListArtwork.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_template_artwork, parent,false);
        RVAListArtwork.ViewHolder holder = new RVAListArtwork.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(RVAListArtwork.ViewHolder holder, final int position) {
